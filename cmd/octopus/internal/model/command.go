...
Examples:
  octopus model                    # Show current default model
  octopus model gpt-5.2           # Set gpt-5.2 as default
  octopus model claude-sonnet-4.6 # Set claude-sonnet-4.6 as default
  octopus model local-model       # Set local VLLM server as default
