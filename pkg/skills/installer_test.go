...
func TestParseGitHubRef(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			repo:         "ilibx/octopus",
			wantOwner:    "sipeed",
			wantRepoName: "octopus",
			wantRef:      "main",
			wantSubPath:  "",
		},
		{
			name:         "owner/repo with subpath",
			repo:         "ilibx/octopus/skills/test",
			wantOwner:    "sipeed",
			wantRepoName: "octopus",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/ilibx/octopus/tree/dev/skills/test",
			wantOwner:    "sipeed",
			wantRepoName: "octopus",
			wantRef:      "dev",
			wantSubPath:  "skills/test",
		},
		{
			...
			repo:         "https://github.com/ilibx/octopus/blob/main/README.md",
			wantOwner:    "sipeed",
			wantRepoName: "octopus",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/ilibx/octopus",
			wantOwner:    "sipeed",
			wantRepoName: "octopus",
			wantRef:      "main",
			wantSubPath:  "",
...
func TestSkillInstaller_InstallFromGitHub_SkillAlreadyExists(t *testing.T) {
	...
	existingSkill := filepath.Join(skillsDir, "octopus")
	...
	err = installer.InstallFromGitHub(context.Background(), "ilibx/octopus")
	if err == nil {
