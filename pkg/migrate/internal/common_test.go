...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.octopus")
	assert.Equal(t, "/home/user/.octopus/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.octopus/workspace/file.txt", "/home/user/.octopus")
