...
import (
	...
	anthropicmessages "github.com/ilibx/octopus/pkg/providers/anthropic_messages"
	"github.com/ilibx/octopus/pkg/providers/azure"
)
...
func createClaudeAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for anthropic. Run: octopus auth login --provider anthropic")
	}
...
func createCodexAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for openai. Run: octopus auth login --provider openai")
	}
