...
import (
	...
	anthropicprovider "github.com/ilibx/octopus/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: octopus auth login --provider anthropic")
		}
