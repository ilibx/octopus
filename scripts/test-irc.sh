...
CONTAINER_NAME="octopus-test-ergo"
IRC_PORT=6667
...
echo ""
echo "Add this to your ~/.octopus/config.json under \"channels\":"
echo ""
echo '  "irc": {'
echo '    "enabled": true,'
...
echo '  }'
echo ""
echo "Then run octopus:"
echo "  cd packages/octopus && go run ./cmd/octopus gateway"
echo ""
